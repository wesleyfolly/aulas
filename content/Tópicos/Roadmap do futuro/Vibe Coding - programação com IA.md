...
```mermaid
flowchart TD
    A["💬 Você descreve o que quer\n(em português)"] --> B["🤖 A IA gera o código"]
    B --> C["👀 Você testa o resultado"]
    C --> D{"Funcionou?"}
    D -- "Sim ✅" --> E["🚀 Usa ou publica"]
    D -- "Não ❌" --> F["💬 Descreve o problema\nou a melhoria"]
    F --> B
    E --> G["💬 Pede nova funcionalidade"]
    G --> B
```
