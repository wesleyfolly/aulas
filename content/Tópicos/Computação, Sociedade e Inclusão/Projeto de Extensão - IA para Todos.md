...
```mermaid
journey
    title Jornada de um participante da oficina
    section Chegada
      Acolhida e apresentação: 4: Participante
      O que você já usa de IA sem saber: 5: Participante
    section Entendendo
      Demonstração ao vivo no telão: 5: Equipe
      Perguntas dos participantes: 4: Participante
    section Fazendo
      Mão na massa no próprio celular: 5: Participante, Equipe
      Identificando um golpe real: 5: Participante
    section Saindo
      Riscos e onde buscar ajuda: 4: Equipe
      Avaliação e material para levar: 5: Participante
```
