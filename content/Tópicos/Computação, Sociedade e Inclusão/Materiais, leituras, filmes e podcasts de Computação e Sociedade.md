---
tipo: referencia
resumo: "Guia de estudo da disciplina: as 10 obras do PPC comentadas, 21 leituras essenciais fora do PPC com nível e marca de acesso aberto, filmes, podcasts e cursos gratuitos verificados em 2026, organizações brasileiras e como estudar com IA sem se enganar."
tags:
  - referencia
...
```mermaid
mindmap
  root((Por onde começar))
    🟢 Trilha iniciante
      Winner 1980, 16 páginas, PDF aberto
      Keynes 1930, 6 páginas
      Santaella 2025, aberto em português
      Elements of AI, capítulo 1
    🔵 Trilha de aprofundamento
      Zuboff, capitalismo de vigilância
      Crawford, Atlas of AI
      Narayanan e Kapoor, AI as Normal Technology
      Ethics of AI, Helsinque
    🇧🇷 Trilha brasileira
      Milton Santos, Por uma outra globalização
      Tarcízio Silva, Racismo Algorítmico
      Dagnino, Tecnologia Social, PDF aberto
      Antunes, O privilégio da servidão
      Krenak, Ideias para adiar o fim do mundo
    🎬 Trilha de filmes
      Coded Bias
      GIG, a uberização do trabalho
      AlphaGo, canal da DeepMind
...
```mermaid
flowchart TD
    Q["🧭 O que você quer<br/>entender agora?"]
    Q --> N["A técnica<br/>é neutra?"]
    Q --> T["Vou perder o emprego<br/>para a IA?"]
    Q --> P["Quem manda<br/>nas plataformas?"]
    Q --> V["Por que o modelo erra<br/>mais com uns<br/>do que com outros?"]
    Q --> B["E no Brasil?"]
    N --> N1["🔓 Winner 1980<br/>+ Dagnino 2014"]
    T --> T1["🔓 Keynes 1930<br/>+ Acemoglu e Johnson 2023"]
    P --> P1["Zuboff 2021<br/>+ Souza et al. 2018 📗"]
    V --> V1["🔓 Tarcízio Silva 2022<br/>+ Benjamin 2019"]
    B --> B1["🔓 Milton Santos 2000<br/>+ CETIC.br, TIC Domicílios"]
    classDef aberto stroke:#2f855a,stroke-width:3px
    class N1,T1,V1,B1 aberto
```
