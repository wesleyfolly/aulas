---
tipo: referencia
resumo: "Glossário A-Z da disciplina: mais de 110 termos de filosofia da técnica, trabalho, poder, vieses, cultura, REA, cidadania e tecnologia social, cada um em poucas linhas, com autor, ano e link para a página que o desenvolve."
tags:
  - aula
...
mindmap
  root((Glossário CSI))
    Fundamentação crítica
      ...
      Construtivismo social SCOT
      Artefatos têm política
      Sistema sociotécnico
      Gestell
      Quatro acepções de tecnologia
    Computador na sociedade
      IA generativa
      Agente de IA
      Data center e Redata
      Desemprego tecnológico
      Polarização de tarefas
      Gig economy e uberização
    Poder e vigilância
      Panóptico
    ...
    Tecnologia social
      ...
      Ferramenta convivial
      Civic tech
      Infraestrutura pública digital
    Relevância social e investimento
      FNDCT
      Lei do Bem
      PBIA
