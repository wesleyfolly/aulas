...
tipo: disciplina
resumo: "Disciplina de Computação, Sociedade e Inclusão: a transformação do mundo pela inteligência artificial (trabalho, poder, cultura, cidadania e inclusão), lida com lente filosófica e tecnológica, com mão na massa e um projeto de extensão com a comunidade."
tags:
  - disciplina
...
```mermaid
flowchart LR
    subgraph L["🔍 Parte 1: As lentes"]
        A[Tecnologia não é neutra] --> B[Filosofia da tecnologia] --> C[A virada da IA] --> D[Trabalho e automação]
    end
    subgraph P["👁️ Parte 2: Poder, cultura, inclusão"]
        E[Poder e vigilância] --> F[Cultura e identidade] --> G[Vieses e inclusão]
    end
    subgraph S["🌱 Parte 3: Abertura e cidadania"]
        H[REA] --> I[Cidadania e educação] --> J[Tecnologia social] --> K[Políticas e investimento]
    end
    L --> P --> S
    S --> M[👷 Engenheiro em 2036]
    P -.-> X(["🤝 Projeto de extensão<br/>IA para Todos"])
    S --> X
