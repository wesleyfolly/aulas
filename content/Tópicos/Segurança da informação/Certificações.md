---
tipo: aula
resumo: "Principais certificações em Segurança da Informação e seus requisitos para evolução na carreira."
tags:
  - aula
...
- **Nível:** Avançado
- **Foco:** Gestão de segurança
- **Requisito:** 5 anos de experiência
- **Reconhecimento:** "Gold standard" para gestores

#### CISM — Certified Information Security Manager
- **Nível:** Avançado
- **Foco:** Gestão e governança
