...
```mermaid
timeline
    title Marcos da Computação
    section Pré-digital
        1801 : Tear de Jacquard
             : Programação por cartões perfurados
        1837 : Máquina Analítica de Babbage
             : Primeiro conceito de computador
        1890 : Tabuladora de Hollerith
             : Base da futura IBM
    ...
    section Primeiros Computadores
        ...
        1948 : Manchester Baby
             : Primeiro programa armazenado executado
    ...
    section Era dos PCs
        ...
        1976 : Apple
             : Jobs e Wozniak na garagem
        1981 : IBM PC
             : PC entra no escritório
    section Era da Internet
        1989 : World Wide Web
             : Tim Berners-Lee no CERN
        1991 : Linux
             : Linus Torvalds
        1998 : Google
             : Buscas em escala global
    section Era da IA
        2007 : iPhone
             : Computação móvel massificada
        2017 : Transformer
             : Attention Is All You Need
        2022 : ChatGPT
             : IA generativa para todos
        2024 : GPT-4o e Sora
             : Multimodal e vídeo por texto
        2026 : IA integrada ao cotidiano
             : Copilot, Gemini, Apple Intelligence
```
