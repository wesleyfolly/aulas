...
```mermaid
flowchart TD
    A([🎓 Você: iniciante em redes]) --> B{Qual caminho?}

    B -->|Vendor-neutral\ngeral| C[CompTIA Network+\nUS$ 369 · N10-009]
    B -->|Cisco\n mais empregabilidade| D[CCNA\nUS$ 300 · 200-301]
    B -->|Cisco grátis primeiro| E[NetAcad: CCNAv7\ngratuito online]
    ...
    F -->|Segurança| G[CompTIA Security+\nou CCNP Security]
    F -->|Cisco avançado| H[CCNP Enterprise\nUS$ 400+]
    F -->|Nuvem| I[Azure Admin\nUS$ 165]
    F -->|Juniper ISP| J[JNCIA-Junos\nUS$ 200 · JN0-106]

    G --> K([🏆 Sênior: CISSP\nUS$ 749])
    H --> K
    I --> K
    J --> L([🟢 JNCIS-ENT\nNível Especialista Juniper])
```
