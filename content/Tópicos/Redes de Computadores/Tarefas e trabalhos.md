---
tipo: recurso
resumo: Lista de tarefas e trabalhos da disciplina de Redes de Computadores
tags:
  - redes
  - tarefas
  - trabalhos
...
> Não tem problema, você irá fazer a mesma coisa porém só com um dispositivo, com todas as configurações de rede do seu celular.
...
- Se possui protocolo WPS ativado
- Nível de sinal
...
1. O que os concursos pedem de redes na área de TI em geral (analisar editais)
2. O que os concursos pedem na área específica de Redes (analisar editais)
3. O que as empresas pedem de conhecimento em redes para vagas de TI em geral (analisar vagas no linkedin)
4. O que as empresas pedem em vagas específicas de Redes (analisar vagas no linkedin)
...
**Recursos relacionados:** [[Docker - gerenciamento de containers]]
