---
tipo: aula
resumo: "Startups: conceitos, características e ecossistema de empresas inovadoras de alto crescimento, metodologias ágeis e cultura empreendedora."
tags:
  - aula
  - startup
  - inovação
...
```mermaid
pie title Startups Ativas por Vertical (Brasil 2025)
    "Fintechs" : 919
    "Agtechs" : 847
    "Healthtechs" : 622
    "Retailtechs" : 513
...
```mermaid
flowchart TD
    A["📢 Open Call\n(1-3 meses)\n800-3.000 inscrições"] --> B["🔍 Screening\n1-5% aceitos\n10-30 startups por batch"]
    B --> C["📝 Term Sheet\ne Kickoff"]
    C --> D["🏃 Programa Intensivo\n3-6 meses\nMentoria + Workshops"]
    D --> E["🎤 Demo Day\npitch para investidores"]
    E --> F["🌱 Pós-programa\nRede de alumni e follow-on"]
```
...
```mermaid
flowchart TD
    A["🌍 TAM\nTotal Addressable Market\nMercado total disponível"] --> B["🎯 SAM\nServiceable Addressable Market\nMercado que a startup consegue atingir"]
    B --> C["🏹 SOM\nServiceable Obtainable Market\nFatia realista nos próximos 1-3 anos"]
```
