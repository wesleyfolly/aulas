---
tipo: aula
resumo: "Marketing: conceitos fundamentais, estratégias de marketing pessoal e empresarial, mix de marketing e plano de marketing para empreendedores."
tags:
  - aula
  - marketing
  - estratégia
...
```mermaid
graph TD
    A["🎯 Mix de Marketing"] --> B["Produto\nO que ofereço?"]
    A --> C["Preço\nQuanto custa?"]
    A --> D["Praça\nOnde venderei?"]
    A --> E["Promoção\nComo comunicarei?"]
    B --> F["Proposta de Valor"]
    C --> F
    D --> F
    E --> F
