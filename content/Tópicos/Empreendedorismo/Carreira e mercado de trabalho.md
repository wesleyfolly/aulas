---
tipo: aula
resumo: "Carreira e mercado de trabalho: plataformas de freelance e trabalho independente, análise de vagas de TI em áreas como segurança da informação, programação e montagem e manutenção."
tags:
  - aula
  - carreira
  - mercado-de-trabalho
...
```mermaid
graph LR
    A["🎓 Formados/ano<br/>~53 mil"] -->|deficit| B["📊 Demanda/ano<br/>~159 mil"]
    B --> C["🕳️ Gap: ~106 mil vagas<br/>sem profissional qualificado"]
    C --> D["✅ Oportunidade para<br/>quem se qualifica AGORA"]
```
...
```mermaid
flowchart TD
    IA["🤖 Avanço da IA Generativa"] --> A["🆕 Cargos que surgem"]
    IA --> B["🔄 Cargos que se transformam"]
    IA --> C["⬇️ Cargos que diminuem"]

    A --> A1["Engenheiro de Prompts"]
    A --> A2["Especialista em IA Confiável"]
    A --> A3["Arquiteto de RAG/LLM"]
    A --> A4["Analista de Dados com IA"]

    B --> B1["Desenvolvedor: usa IA para codificar"]
    B --> B2["Analista de Seg.: usa IA para detectar ameaças"]
    B --> B3["Suporte TI: IA resolve tickets simples"]

    C --> C1["Entrada de dados manual"]
    C --> C2["Testes manuais repetitivos"]
    C --> C3["Atendimento básico roteirizado"]
```
...
```mermaid
timeline
    title Inovações nascidas dentro de empresas
    section Décadas 1950-1980
        3M : Post-it criado por funcionário usando 15% do tempo livre
        HP : Cultura de laboratório interno aberta a todos
    section Anos 2000-2010
        Google : Gmail surgiu de projeto pessoal de funcionário (regra dos 20%)
        Amazon : AWS começou como projeto interno de infraestrutura
    section Anos 2010-2026
        Ambev : Programa "Ambev Lab" para testar ideias internas
        Natura : Funcionários recebem participação financeira por inovações aprovadas
```
...
```mermaid
journey
    title Jornada do estudante de TI ao mercado
    section Formação técnica
        Aprender fundamentos: 5: Estudante
        Projetos práticos e extensão: 4: Estudante
        Banco de portfólio: 3: Estudante
    section Primeira experiência
        Estágio ou freelance: 4: Estudante, Empresa
        Contribuir para open source: 3: Estudante
        Certificações básicas: 4: Estudante
    section Entrada no mercado
        Primeiro emprego CLT ou PJ: 5: Profissional, Empresa
        Networking no LinkedIn: 4: Profissional
        Especialização em área de interesse: 5: Profissional
    section Crescimento
        Sênior ou especialista: 5: Profissional, Empresa
        Liderança técnica ou gestão: 4: Profissional, Empresa
        Empreender ou freelance avançado: 5: Profissional
```
...
```mermaid
graph TD
    A["🏆 Profissional valorizado em 2026"] --> B["Hard Skills<br/>técnicas atualizadas"]
    A --> C["Soft Skills<br/>comunicação, adaptação"]
    A --> D["Visão de negócio<br/>entender o cliente e o problema"]
    B --> E["Python, Cloud, Seg. da Info,<br/>IA, DevOps"]
    C --> F["Trabalho em equipe,<br/>proatividade, gestão do tempo"]
    D --> G["Intraempreendedorismo,<br/>foco em resultado, autonomia"]
```
