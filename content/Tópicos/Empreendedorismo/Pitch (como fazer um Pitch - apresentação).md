---
tipo: aula
resumo: "Pitch: técnicas e metodologias para criar e apresentar pitches eficazes, comunicação de ideias de negócio para investidores, clientes e parceiros."
tags:
  - aula
  - pitch
  - apresentação
...
```mermaid
flowchart LR
    A["😣 Problema\n(dor real do cliente)"] --> B["💡 Solução\n(produto / serviço)"]
    B --> C["📊 Mercado\n(TAM / SAM / SOM)"]
    C --> D["💰 Modelo\n(como ganha dinheiro)"]
    D --> E["🏆 Tração\n(provas de mercado)"]
    E --> F["👥 Time\n(por que vocês?)"]
    F --> G["🤝 Ask\n(quanto busca e para quê)"]

    style A fill:#ff6b6b,color:#fff
    style B fill:#4ecdc4,color:#fff
    style C fill:#45b7d1,color:#fff
    style D fill:#96e6a1,color:#000
    style E fill:#ffd93d,color:#000
    style F fill:#c3a6ff,color:#000
