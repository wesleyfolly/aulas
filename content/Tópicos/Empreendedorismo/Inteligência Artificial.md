---
tipo: aula
resumo: "Inteligência Artificial: introdução aos conceitos básicos, tipos de IA (fraca, forte, geral), subáreas (machine learning, NLP, visão computacional) e ferramentas atuais como ChatGPT, Claude, Gemini, Perplexity, Midjourney, DALL-E e outras plataformas de IA generativa."
tags:
  - aula
...
graph TD
    ...
    IA --> NarrowAI["IA Fraca (Narrow AI)\nFaz 1 coisa muito bem"]
    IA --> GeneralAI["IA Forte (Strong AI)\nFaz qualquer tarefa intelectual"]
    IA --> AGI["AGI\nConsciência e raciocínio abstrato\n(ainda teórico)"]

    NarrowAI --> ML["Machine Learning\n(aprende com dados)"]
    NarrowAI --> NLP["Processamento de\nLinguagem Natural"]
    NarrowAI --> CV["Visão Computacional"]
    NarrowAI --> GenAI["IA Generativa\n(texto, imagem, vídeo, áudio)"]

    ML --> DL["Deep Learning\n(redes neurais profundas)"]

    style IA fill:#6366f1,color:#fff
    style NarrowAI fill:#3b82f6,color:#fff
    style GeneralAI fill:#8b5cf6,color:#fff
    style AGI fill:#ec4899,color:#fff
    style GenAI fill:#f59e0b,color:#000
```
...
graph LR
    ...
    Zapier -->|"Ideal para"| Z1["Iniciantes\nAutomações simples"]
    Make -->|"Ideal para"| M1["Processos complexos\nEquipes"]
    N8N -->|"Ideal para"| N1["Técnicos\nAgentes com IA"]

    style Zapier fill:#ff4a00,color:#fff
    style Make fill:#a259ff,color:#fff
    style N8N fill:#eb5757,color:#fff
```
