---
tipo: aula
resumo: "OKR (Objectives and Key Results): metodologia de gestão e definição de objetivos usada no Vale do Silício para alinhar equipes e medir resultados de forma eficiente."
tags:
  - aula
  - OKR
  - metodologia
...
```mermaid
timeline
    title Linha do Tempo dos OKRs
    1954 : Peter Drucker cria MBO
    1970s : Andy Grove adapta para Intel como iMBO
    1983 : John Doerr aprende na Intel
    1999 : Doerr apresenta OKRs ao Google (40 funcionários)
    2000s : Google escala com OKRs
    2013 : LinkedIn, Twitter e Spotify adotam
    2018 : Livro "Measure What Matters" populariza globalmente
    2025 : Mercado de software OKR atinge US$ 1,6 bi
```
...
```mermaid
graph TD
    O["🎯 Objetivo (Qualitativo, Inspirador)"]
    KR1["📊 Key Result 1 (Número)"]
    KR2["📊 Key Result 2 (Número)"]
    KR3["📊 Key Result 3 (Número)"]
    O --> KR1
    O --> KR2
    O --> KR3
```
...
```mermaid
graph LR
    A["📅 Início do trimestre\nDefinir OKRs"] --> B["📆 Semana 2-3\nAlinhar com equipes"]
    B --> C["🔁 Check-ins semanais\nou quinzenais"]
    C --> D["📊 Metade do trimestre\nRevisão de progresso"]
    D --> C
    C --> E["🏁 Final do trimestre\nGrading (pontuação)"]
    E --> F["🔄 Próximo ciclo\nLições aprendidas"]
    F --> A
```
